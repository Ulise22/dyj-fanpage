    ...
    return(
        <article className={styles.prod}>
            <section className={styles.prod__info}>
                <svg onClick={() => dispatch(removeProducto(prodIndex))} className={styles.prod__trash} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0,0,256,256" style={{fill:"#000000"}}>
            ...
            <p className={styles.prod__eliminar} onClick={() => dispatch(removeProducto(prodIndex))}> Eliminar </p>
        </article>
    )
}